...
import { faFacebook, faTwitter, faLinkedin, faVimeo } from '@fortawesome/free-brands-svg-icons';
import './Footer.css';
      ...
      <Container>
        <Row className="mb-4">
          <Col md={3} className="mb-5">
            <ListGroup variant="flush" className="list-unstyled link">
          ...
          <Col md={3} className="mb-5 pe-md-5 contact-info">
            <p>
        ...
        <Row className="pt-5">
          ...
          <Col md={6} className="text-end social">
            <a href="#">
